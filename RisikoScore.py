# -*- coding: utf-8 -*-
"""
Created on Sat Apr 18 09:24:45 2020

@author: Simone
"""
# 3.Data Exploration (Correlationen, Feature Definition, Plots) [matplotlib, pandas]
# Relevant features for plotting: 
#   medical: volumePerMin, CO2, O2
#   setting:  RR, VT, PEEP, IE 
# Relevant features for Info
#   age, rscore, smoker, ventilationMode
# Relevant features for Pop-up 
#   changeInFrequency, VolumePerMin, CO2, O2, temperature1,2, RR, VT, PEEP, IE
...
class Ventilator:
    ...
    def severity_score(self):
        ...
        def severety_total (a,b,c,d,e,f,g,h):
